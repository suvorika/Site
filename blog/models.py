...
class User(db.Model, UserMixin):
    ...
    user_status = db.Column(
        db.String(40), nullable=True, default="Лучший пользователь проекта"
    )
...
class Post(db.Model):
    ...
    tags = db.relationship(
        "Tag", backref="tag_post", lazy=True, cascade="all, delete-orphan"
    )
    comments = db.relationship(
        "Comment", backref="comment_post", lazy=True, cascade="all, delete-orphan"
    )
